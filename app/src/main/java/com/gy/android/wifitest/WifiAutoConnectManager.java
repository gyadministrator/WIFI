...
public class WifiAutoConnectManager {
    ...
    private WifiAutoConnectManager(WifiManager wifiManager) {
        WifiAutoConnectManager.wifiManager = wifiManager;
    }

    static WifiAutoConnectManager newInstance(WifiManager wifiManager) {
     ...
     * @return
     */
    static int getSignalNumsLevel(int rssi, int numLevels) {
        if (wifiManager == null) {
            return -1;
        }
     ...
     * 获取ssid的加密方式
     */
    static WifiCipherType getCipherType(String ssid) {
        if (wifiManager == null) {
            return null;
        }
     ...
     * 获取所有WIFI AP
     */
    static List<ScanResult> getScanResults() {
